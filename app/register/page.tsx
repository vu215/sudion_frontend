...
export default function RegisterPage() {
  const { register, loginWithGoogle, transitionTo } = useAuth();
  ...
  function handleGoogleRegister() {
    setError("Tính năng Đăng ký bằng Google đang được nâng cấp và chờ kết nối từ Back-End. Vui lòng đăng ký bằng Email bên dưới!");
  }
          ...
          <div className="flex flex-col justify-center px-6 py-8 sm:px-10 order-2 md:order-1">
            <div className="w-full max-w-[360px] mx-auto">
              ...
              <form onSubmit={handleSubmit} className="grid gap-3">
                ...
                >
                  {loading ? "Đang xử lý đăng ký..." : "Tạo tài khoản ngay"}
                </button>
              </form>
              ...
              <div className="relative my-3.5">
                ...
                <div className="relative flex justify-center text-xs uppercase">
                  <span className="bg-white px-2 text-[#64748b] font-medium">Hoặc đăng ký bằng</span>
                </div>
              </div>
              ...
              <button
                ...
                className="flex items-center justify-center gap-2.5 w-full h-11 rounded-xl border border-[#e2e8f0] bg-white hover:bg-[#f8fafc] text-sm font-semibold text-[#1e293b] shadow-sm transition duration-200 cursor-pointer"
              >
