...
function Footer() {
  return (
    <footer data-reveal className="w-full bg-[#0a0a0c] py-10 text-white">
      <div className={`${containerClass} grid grid-cols-2 items-start gap-8 md:grid-cols-5`}>
        <div className="col-span-2 md:col-span-1">
          <div className="flex items-center gap-2">
            ...
            />
            <span className="text-[15px] font-black uppercase tracking-[0.05em] text-orange-500">
              STUDION
            </span>
          </div>
